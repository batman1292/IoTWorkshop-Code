 ...
 */
void BH1750::begin(uint8_t mode, int32_t sda_pin, int32_t scl_pin, int32_t freq ) {

  // Initialize I2C
  Wire.begin( (int) sda_pin, (int) scl_pin );  // default: GPIO4=D2 for SDA, GPIO5=D1 for SCL
  Wire.setClock( freq );   // set I2C speed 
